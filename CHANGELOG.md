...
* Apply all non-valid props to the wrapper element [`#167`](https://github.com/CookPete/react-player/issues/167), [`#183`](https://github.com/CookPete/react-player/pull/183)
* Add Facebook player [`#109`](https://github.com/CookPete/react-player/issues/109)
* Add support for Dailymotion player [`#128`](https://github.com/CookPete/react-player/pull/128)
* Update Vimeo player to use the new Vimeo API [`#142`](https://github.com/CookPete/react-player/pull/142)
