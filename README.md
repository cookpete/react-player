...
* Spotify tracks use the [Spotify Play Button widget](https://developer.spotify.com/documentation/widgets/generate/play-button/)
  * Spotify does not support props, callbacks or methods except the url prop.
