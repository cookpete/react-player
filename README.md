...
For platforms without direct use of `npm` modules (for example [Meteor < 1.3](https://guide.meteor.com/v1.2)), a minified version of `ReactPlayer` is located in `dist` after installing. To generate this file yourself, checkout the repo and run `npm run build:dist`.
