...
const Preview = ({
  ...
  const fetchImage = async ({
    ...
    if (React.isValidElement(light)) return;
  ...
  return (
    <div
      ...
      tabIndex={previewTabIndex ?? 0}  // ✅ Ensure focusable
      aria-label={previewAriaLabel ?? 'Play video'}  // ✅ Default label
      onClick={handleClick}
      onKeyDown={handleKeyPress}  // ✅ Better than onKeyPress
    >
      {isElement ? light : null}
      {playIcon || defaultPlayIcon}
    </div>
