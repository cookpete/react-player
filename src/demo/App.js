...
class App extends Component {
  ...
  render() {
    const {url, playing, volume, muted, loop, played, loaded, duration, playbackRate, cookies} = this.state
    const SEPARATOR = ' · '
        ...
        <section className="section">
          ...
          <table>
            <tbody>
              <tr>
                <th>url</th>
                <td className={!url ? 'faded' : ''}>{(url instanceof Array ? 'Multiple' : url) || 'null'}</td>
              </tr>
              <tr>
                <th>playing</th>
